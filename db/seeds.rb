...
Comment.create(content: "He was one of the leading revolutionary generals of the Mexican War of Independence. He fought against Spain for independence in the early 19th century, and later served as President of Mexico.", answer: true, user_id: 3, post_id: nil, question_id: 1)
Comment.create(content: "Thanks for the answer, Toussaint!", answer: false, user_id: 4, post_id: nil, question_id: 1)
Comment.create(content: "She was and is a phenomenal woman!", answer: false, user_id: 2, post_id: 9, question_id: nil)